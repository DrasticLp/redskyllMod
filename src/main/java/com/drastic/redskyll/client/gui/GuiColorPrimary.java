...
public class GuiColorPrimary extends GuiScreen
{
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        ...
        else if(button.id == 5)
        {
            ...
            this.mc.player.sendMessage(new TextComponentString(TextFormatting.GREEN + "Vous venez de changer la couleur primaire en : " + TextFormatting.RED + "ROUGE"));
        }
        else if(button.id == 6)
        {
        ...
        {
            ConfigColor.primary = "orange";
            ConfigColor.pimaryInt = Color.orange.getRGB();
            this.mc.player.sendMessage(new TextComponentString(TextFormatting.GREEN + "Vous venez de changer la couleur primaire en : " + TextFormatting.GOLD + "ORANGE"));
        }
        else if(button.id == 8)
        {
            ConfigColor.primary = "yellow";
            ConfigColor.pimaryInt = Color.yellow.getRGB();
            this.mc.player.sendMessage(new TextComponentString(TextFormatting.GREEN + "Vous venez de changer la couleur primaire en : " + TextFormatting.YELLOW + "JAUNE"));
        }
        else if(button.id == 9)
        {
            ConfigColor.primary = "green";
            ConfigColor.pimaryInt = Color.green.getRGB();
            this.mc.player.sendMessage(new TextComponentString(TextFormatting.GREEN + "Vous venez de changer la couleur primaire en : " + TextFormatting.GREEN + "VERT"));
        }
        else if(button.id == 10)
        {
            ConfigColor.primary = "magenta";
            ConfigColor.pimaryInt = Color.magenta.getRGB();
            this.mc.player.sendMessage(new TextComponentString(TextFormatting.GREEN + "Vous venez de changer la couleur primaire en : " + TextFormatting.DARK_PURPLE + "MAGENTA"));
        }
        else if(button.id == 11)
        {
            ConfigColor.primary = "cyan";
            ConfigColor.pimaryInt = Color.cyan.getRGB();
            this.mc.player.sendMessage(new TextComponentString(TextFormatting.GREEN + "Vous venez de changer la couleur primaire en : " + TextFormatting.AQUA + "CYAN"));
        }
        else if(button.id == 12)
        {
            ConfigColor.primary = "blue";
            ConfigColor.pimaryInt = Color.blue.getRGB();
            this.mc.player.sendMessage(new TextComponentString(TextFormatting.GREEN + "Vous venez de changer la couleur primaire en : " + TextFormatting.BLUE + "BLEU"));
        }
