...
public class GuiMoney extends InventoryEffectRenderer implements IRecipeShownListener
{
    
    public static final ResourceLocation INVENTORY_BACK = new ResourceLocation(Reference.MODID + ":textures/gui/inventory.png");
    /** The X size of the inventory window in pixels. */
    protected int sizeX = 243;
    /** The Y size of the inventory window in pixels. */
    protected int sizeY = 166;
    ...
    IMoney money = Minecraft.getMinecraft().player.getCapability(MoneyProvider.MONEY_CAP, null);
    
    private String stringMoney = money.getMoneyString();
    
    public GuiMoney(EntityPlayer player)
    {
    ...
    public void initGui()
    {
        ...
        this.recipeButton = new GuiButtonImage(10, this.guiLeft + 104, this.height / 2 - 22, 20, 18, 178, 0, 19, INVENTORY_BACK);
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY)
    {
        ...
        this.fontRenderer.drawString(stringMoney, 178, 92, 2171169);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        this.mc.getTextureManager().bindTexture(INVENTORY_BACK);
        int i = this.guiLeft;
        int j = this.guiTop;
        this.drawTexturedModalRect(i, j, 0, 0, this.sizeX, this.sizeY);
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if(button.id == 10)
        {
            ...
            //this.stringMoney.setPosition(this.guiLeft + 149, this.height / 2 - 22);
