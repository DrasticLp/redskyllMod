...
public class RenderIceBlock extends Render<EntityIceBlock>
{
    ...
    public RenderIceBlock(RenderManager renderManager, float scaleIn)
    {
        super(renderManager);
        this.scale = scaleIn;
    }

    public void doRender(EntityIceBlock entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(ItemInit.ICE_ATTACK);
