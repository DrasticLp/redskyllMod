...
public class RenderFuseT2 extends RenderLiving<EntityFuseBase> 
{
    protected static ModelBase modelFuse = new ModelFuse();

    public static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MODID + ":textures/entity/fuse_tier_2.png");

    public RenderFuseT2(RenderManager renderManager)
    {
