...
import com.drastic.redskyll.client.models.entity.DirtBlock;
...
public class RenderDirtBlock extends Render<EntityDirtBlock>
{
    private final float scale;

    public RenderDirtBlock(RenderManager renderManager, float scaleIn)
    {
        super(renderManager);
        this.scale = scaleIn;
    }

    public void doRender(EntityDirtBlock entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(ItemInit.EARTH_ATTACK);
     ...
     */
    protected ResourceLocation getEntityTexture(EntityDirtBlock entity)
    {
