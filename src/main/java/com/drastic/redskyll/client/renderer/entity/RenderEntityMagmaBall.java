...
public class RenderEntityMagmaBall extends Render<EntityProjectileBase>
{
    private final float scale;

    public RenderEntityMagmaBall(RenderManager renderManager, float scaleIn)
    {
        super(renderManager);
        this.scale = scaleIn;
    }
    ...
    public void doRender(EntityProjectileBase entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        ...
        TextureAtlasSprite textureatlassprite = Minecraft.getMinecraft().getRenderItem().getItemModelMesher().getParticleIcon(ItemInit.MAGMA_BALL);
