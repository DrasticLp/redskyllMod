package com.drastic.redskyll.blockhit.common.helper;

import java.util.Set;

import com.drastic.redskyll.blockhit.config.ConfigBuildHandler;
import com.drastic.redskyll.blockhit.config.StringListParser;
...
public class ItemBlockingHelper
{
    ...
    public static void sync()
    {
        ...
        exclude = parser.buildItemSetWithCondition(Lists.newArrayList(ConfigBuildHandler.swordBlockingConfig.exclude), item -> item instanceof ItemSword, "No instance of ItemSword");
        include = parser.buildItemSetWithCondition(Lists.newArrayList(ConfigBuildHandler.swordBlockingConfig.include), item -> !(item instanceof ItemSword), "Already is instance of ItemSword");
    }
