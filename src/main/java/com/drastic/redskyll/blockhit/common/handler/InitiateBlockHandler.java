...
public class InitiateBlockHandler
{
    ...
    public void onLivingAttack(final LivingAttackEvent evt)
    {
        ...
        if(ConfigBuildHandler.swordBlockingConfig.deflectProjectiles && evt.getEntityLiving() instanceof EntityPlayer && evt.getSource().getImmediateSource() instanceof EntityArrow && this.blockingHelper.getIsBlocking((EntityPlayer)evt.getEntityLiving()))
        {
