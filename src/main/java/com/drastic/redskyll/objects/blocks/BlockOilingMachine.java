...
public class BlockOilingMachine extends Block implements IHasModel
{
    private static int count = 0;

    private static String type;

    public ItemStack stack0 = new ItemStack(Blocks.AIR), stack1 = new ItemStack(Blocks.AIR);

    public static final PropertyDirection FACING = BlockHorizontal.FACING;

    public BlockOilingMachine(String name, Material material)
    {
        super(material);
    ...
    {
        return new TileEntityOilingMachine();
    }

    @Override
    public Item getItemDropped(IBlockState state, Random rand, int fortune)
    {
        return Item.getItemFromBlock(BlockInit.OILING_MACHINE);
    }

    @Override
    public ItemStack getItem(World worldIn, BlockPos pos, IBlockState state)
    {
        return new ItemStack(BlockInit.OILING_MACHINE);
    }
    ...
    public List<ItemStack> getDrops(IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
    {
        ...
        list.add(new ItemStack(BlockInit.OILING_MACHINE));
        return list;
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        if(!worldIn.isRemote)
        {
            playerIn.openGui(Main.instance, Reference.GUI_OIL_MACHINE, worldIn, pos.getX(), pos.getY(), pos.getZ());
        }
        return true;
    }
