...
public class ContainerSinteringFurnace extends Container
{
    ...
    public void detectAndSendChanges()
    {
        ...
        if(this.tileentity.getBlock() == BlockInit.MAGICAL_CAULDRON)
        {
            ((BlockMagicalCauldron)this.tileentity.getBlock()).stack0 = this.inventorySlots.get(0).getStack();
            ((BlockMagicalCauldron)this.tileentity.getBlock()).stack1 = this.inventorySlots.get(1).getStack();
            ((BlockMagicalCauldron)this.tileentity.getBlock()).stack2 = this.inventorySlots.get(2).getStack();
            ((BlockMagicalCauldron)this.tileentity.getBlock()).stack3 = this.inventorySlots.get(3).getStack();
        }
