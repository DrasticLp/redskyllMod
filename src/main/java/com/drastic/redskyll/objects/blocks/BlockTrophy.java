...
public class BlockTrophy extends Block implements IHasModel
{
    public static final PropertyDirection FACING = BlockHorizontal.FACING;
    public static final AxisAlignedBB FULL_BLOCK_AABB = new AxisAlignedBB(0.0D, 0.0D, 0.0D, 1.0D, 2.0D, 1.0D);

    public BlockTrophy(String name, Material material)
    {
        super(material);
