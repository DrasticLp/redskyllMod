...
public class BlockFuseT2 extends Block implements IHasModel
{
    private static int timer;
    private static boolean isFlying = false;

    public BlockFuseT2(String name, Material material)
    {
        super(material);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        EntityFuseT2 entitytntprimed = new EntityFuseT2(worldIn, (double)((float)pos.getX() + 0.5F), (double)pos.getY(), (double)((float)pos.getZ() + 0.5F));
