...
public class EntityMinionDiamond extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityWolf.class, DataSerializers.FLOAT);
    
    public EntityMinionDiamond(World worldIn)
    {
        super(worldIn);
    ...
    public EntityMinionDiamond(World worldIn, double x, double y, double z)
    {
        super(worldIn);
        this.setSize(0.6F, 0.85F);
        this.setTamed(false);
        ...
        {         
            ...
            {       
                if(mana.getMana() != 0)
                {
                    ...
                    player.addItemStackToInventory(new ItemStack(ItemInit.MINION)); 
                }
                else
                {
    ...
    @Override
    public EntityMinionDiamond createChild(EntityAgeable ageable)
    {
        EntityMinionDiamond entitywolf = new EntityMinionDiamond(this.world);
    ...
    {
        private final EntityMinionDiamond wolf;

        public AIAvoidEntity(EntityMinionDiamond wolfIn, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_)
        {
        ...
        {
            return p_190854_1_.getStrength() >= EntityMinionDiamond.this.rand.nextInt(5);
        }
        ...
        {
            EntityMinionDiamond.this.setAttackTarget((EntityLivingBase)null);
