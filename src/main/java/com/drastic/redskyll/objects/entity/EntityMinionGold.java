...
public class EntityMinionGold extends EntityTameable
{
    private static final DataParameter<Float> DATA_HEALTH_ID = EntityDataManager.<Float>createKey(EntityWolf.class, DataSerializers.FLOAT);

    
    public EntityMinionGold(World worldIn)
    {
        super(worldIn);
    ...
    public EntityMinionGold(World worldIn, double x, double y, double z)
    {
        super(worldIn);
        this.setSize(0.6F, 0.85F);
        this.setTamed(false);
        ...
        if(this.isTamed())
        {
            ...
            {     
                ...
                if(mana.getMana() != 0)
                {
                    ...
                    player.addItemStackToInventory(new ItemStack(ItemInit.MINION_GOLD)); 
                }
                else
                {
    ...
    @Override
    public EntityMinionGold createChild(EntityAgeable ageable)
    {
        EntityMinionGold entitywolf = new EntityMinionGold(this.world);
    ...
    {
        private final EntityMinionGold wolf;

        public AIAvoidEntity(EntityMinionGold wolfIn, Class<T> p_i47251_3_, float p_i47251_4_, double p_i47251_5_, double p_i47251_7_)
        {
        ...
        {
            return p_190854_1_.getStrength() >= EntityMinionGold.this.rand.nextInt(5);
        }
        ...
        {
            EntityMinionGold.this.setAttackTarget((EntityLivingBase)null);
