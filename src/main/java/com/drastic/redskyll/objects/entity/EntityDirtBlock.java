...
public class EntityDirtBlock extends EntityProjectileBase
{
    public EntityDirtBlock(World par1World)
    {
        super(par1World);
    }

    public EntityDirtBlock(World par1World, Entity par2Entity)
    {
        super(par1World, par2Entity);
    }
    
    public EntityDirtBlock(World par1World, EntityBabyDragonBase par3EntityPlayer)
    {
        super(par1World, par3EntityPlayer);
    }
    
    public EntityDirtBlock(World par1World, EntityBabyDragonBase par3EntityPlayer, Entity target)
    {
