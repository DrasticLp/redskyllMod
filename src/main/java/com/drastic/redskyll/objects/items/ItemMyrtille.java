...
public class ItemMyrtille extends ItemFood implements IHasModel, IPlantable
{   
    public ItemMyrtille(String name, int amount, boolean isWolfFood)
    {
    ...
    public EnumActionResult onItemUse(EntityPlayer player, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ)
    {
        ...
        {
            worldIn.setBlockState(pos.up(), BlockInit.CROP_MYRTILLE.getDefaultState());
            stack.shrink(1);
    ...
    {
        return BlockInit.CROP_MYRTILLE.getDefaultState();
    }
}
