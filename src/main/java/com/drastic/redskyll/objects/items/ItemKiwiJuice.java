...
public class ItemKiwiJuice extends ItemFood implements IHasModel
{
    public ItemKiwiJuice(String name, int amount, boolean isWolfFood)
    {
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player)
    {
        ...
        if(mana.getMana() != 20 && mana.getMana() != 19)
        {
