...
public class ItemBowMod extends ItemBow implements IHasModel
{
    public ItemBowMod(String name)
    {
            ...
            if (!itemstack.isEmpty() || flag)
            {
                ...
                if ((double)f >= 0.1D)
                {
                    ...
                    if (!worldIn.isRemote)
                    {
                        ...
                        if (j > 0)
                        {
                            entityarrow.setDamage(entityarrow.getDamage() + (double)j * 1.5D + 0.5D);
                        }
