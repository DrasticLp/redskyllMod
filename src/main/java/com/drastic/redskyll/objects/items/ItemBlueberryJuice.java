...
public class ItemBlueberryJuice extends ItemFood implements IHasModel
{
    public ItemBlueberryJuice(String name, int amount, boolean isWolfFood)
    {
    ...
    protected void onFoodEaten(ItemStack stack, World worldIn, EntityPlayer player)
    {
        ...
        if(mana.getMana() != 20 && mana.getMana() != 17 && mana.getMana() != 18 && mana.getMana() != 19)
        {
            mana.setMana(mana.getMana() + 4);
        }
